...
const addComment = async (blog, comment) => {
  const response = await axios.post(`${baseUrl}/${blog.id.toString()}/comments`, { comment:comment })
  return response.data
}

export default { getAll, setToken, getForUser, createNewBlog, updateLikes, deleteBlog, addComment }